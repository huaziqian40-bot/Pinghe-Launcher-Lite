...
<div class="small">Pinghe Launcher Lite UI 閾捐矾 OK 路 绐楀彛鍗冲皢鑷姩鍏抽棴</div></div></body></html>"""
...
window = webview.create_window("Pinghe Launcher Lite 娓叉煋娴嬭瘯", html=html, width=440, height=280)
